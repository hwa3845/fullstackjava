...
<form action="ex08.jsp" method="post">	
	...
	<input type="checkbox" name="ck" value="ck2">item2
	<input type="checkbox" name="ck" value="ck3">item3<br>
	<input type="radio" name="ra"  value="i1">item1
	<input type="radio" name="ra" value="i2">item2 <!-- radio는 name이 같아야함 -->
	<input type="radio" name="ra" value="i3">item3<br> <!-- value로 구분 가능해야 함 -->
	<input type="submit">
</form>
<br>
