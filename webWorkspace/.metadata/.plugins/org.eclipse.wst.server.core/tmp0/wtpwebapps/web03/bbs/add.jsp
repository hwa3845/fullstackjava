...
<table width="800" align="center">
	...
	<tr>
		...
		if(request.getMethod().equals("POST")){
			...
			String sql="insert into bbs02 (num,id,subject,content,nalja) values"+ 
					"(bbs02_seq.nextval,'"+id+"','"+subject+"','"+content+"',sysdate)";
		...
		<form action="add.jsp" method="post"> <!-- 입력값을 가지고 내 페이지로 다시 돌아옴 -->
		<table align="center">
			<tr>
			...
			<tr>
				<td bgcolor="gray" align="center">아이디</td>
				<td><input type="text" name="id" value="<%=id %>"></td>
			</tr>
			<tr>
				<td colspan="2"><textarea name="content" cols="50" rows="4"><%=content %></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
