<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*, java.sql.*, com.web08.model.*"%>
...
<%
//jsp:useBean 코드에 bean을 만든 것이기 때문에 변수명 중복으로 오류
//Bbs07Bean bean=null;
...
<form action="edit.jsp">
	...
	<div>
		<label>sub</label><input name="sub" value="<%=bean.getSub() %>">
	</div>
	<div>
		<label>id</label><input name="id" value="<%=bean.getId() %>">
	</div>
	<div>
