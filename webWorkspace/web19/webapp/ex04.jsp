...
%>
<!-- 
<p>set:<c:set var="msg" value="문자열"></c:set></p>
<p>set:<c:set var="msg">abcd</c:set></p>
 -->
<!-- 
<p>out:<c:out value="1234"></c:out></p>
<p>out:<c:out value="문자열"></c:out></p>
 -->
<p>set:<c:set var="msg" scope="page">abc</c:set></p>
<p>out:<c:out value="${requestScope.msg }" default="없음"></c:out></p>
<!-- 그냥 부르면 빈칸이지만 jstl로 부르면 default 값을 가질 수 있음 -->
