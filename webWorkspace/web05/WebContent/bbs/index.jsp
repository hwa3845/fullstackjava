...
<body>
	...
	<table width="800" border="1" cellspacing="0">
		...
		<%	
			...
			if (p == null) p = "1";
			//페이징 3가지 방법
			String sql = "SELECT * FROM (SELECT * FROM bbs05 WHERE num>(SELECT MAX(num)-"+limit+"*" + p + " FROM bbs05) "
					+ "and num<=(SELECT MAX(num)-"+limit+"*(" + p + "-1) FROM bbs05) LIMIT "+limit+") AS A ORDER BY num DESC";
