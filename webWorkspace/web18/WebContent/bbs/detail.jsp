...
<form action="edit.do" method="post">
	...
	<div>
		<label>subject</label><input class="edit" name="sub" value="<%=bean.getSub() %>" readonly="readonly"/>
	</div>
	<div>
		<label>id</label><input class="edit" name="id" value="<%=bean.getId() %>" readonly="readonly"/>
	</div>
	<div>
		<label>nalja</label><input class="edit" type="date" value="<%=bean.getNalja() %>" disabled/>
	</div>
	<div>
		<textarea class="edit" name="content" readonly="readonly"><%=bean.getContent() %></textarea>
	</div>
	<div>
