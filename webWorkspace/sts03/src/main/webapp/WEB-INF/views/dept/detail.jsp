...
<form class="form-horizontal" action="add.do" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input readonly value="${bean.dname }" class="form-control" name="dname" id="dname" placeholder="dname">
    </div>
  </div>
  <div class="form-group">
    <label for="loc" class="col-sm-2 control-label">location</label>
    <div class="col-sm-10">
      <input readonly value="${bean.loc }" class="form-control" name="loc" id="loc" placeholder="location">
    </div>
  </div>

  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
	  <a role="button" class="btn btn-default" href="edit.do?deptno=${bean.deptno }">수정</a>
